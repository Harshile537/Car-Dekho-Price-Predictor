...
model = joblib.load('D:\\Car Dekho Project\\Data Set_structured\\car_price_prediction_model.pkl')
label_encoders = joblib.load('D:\\Car Dekho Project\\Data Set_structured\\label_encoders.pkl')
scalers = joblib.load('D:\\Car Dekho Project\\Data Set_structured\\scalers.pkl') 

# Load dataset for filtering and identifying similar data
data = pd.read_csv('D:\Car Dekho Project\Data Set_structured\car_dekho_cleaned_dataset_Raw.csv')
